parse_hexbar_jump <- function(time,
  ...
  phases_df <- dplyr::tribble(
    ...
    "Before HexJump", start_time, movement_start_time,
    "Concentric phase", movement_start_time, take_off_time,
    "Flight phase", take_off_time, landing_time,
    "Landing phase", landing_time, impact_peak_time,
    "After HexJump", impact_peak_time, stop_time,
    "", stop_time, Inf
  )
  ...
  sub_phases_df <- dplyr::tribble(
    ...
    "After SJ", impact_peak_time, stop_time,
    "", stop_time, Inf
  )
